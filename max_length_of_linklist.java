...
public class MaxDistance {  
    ...
    public void nodesAtMaxDistance(Node node) {  
        ...
        //Calculates distance between all the nodes present in binary tree and stores maxmum distance in variable maxDistance  
        for(int i = 0; i < treeArray.length; i++) {  
            for(int j = i; j < treeArray.length; j++) {  
                ...
                //If more than one pair of nodes are at maxDistance then, add all pairs to treArray  
